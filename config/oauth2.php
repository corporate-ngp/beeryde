...
return [
    ...
    'grant_types' => [
        'password' => [
            ...
            'access_token_ttl' => env('OAUTH_ACCESS_TOKEN_TTL', 604800),
            'callback' => 'Modules\Api\Oauth2\Verifier\OauthVerifier@verify',
        ],
//        'password' => [
//            'class' => '\League\OAuth2\Server\Grant\PasswordGrant',
...
//            ],
        ...
        'mobile' => [
            'class' => 'Modules\Api\Oauth2\Grant\MobileGrant',
            'access_token_ttl' => env('OAUTH_ACCESS_TOKEN_TTL', 3600),
            'callback' => 'Modules\Api\Oauth2\Verifier\OauthMobileVerifier@verify',
        ],
    ],
    /*
      |--------------------------------------------------------------------------
