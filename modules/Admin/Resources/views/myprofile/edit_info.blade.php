...
<div id="user-info">
    ...
    <div class="form-group">
        ...
        {!! Form::text('last_name', null, ['class'=>'form-control', 'id'=>'last_name', 'data-rule-required'=>'true', 'data-msg-required'=> trans('admin::messages.required-enter', ['name' => trans('admin::controller/user.last-name')]), 'data-rule-maxlength'=>'60', 'data-msg-maxlength'=> trans('admin::messages.error-maxlength',['name'=> trans('admin::controller/user.last-name')]) ]) !!}
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        {!! Form::text('contact', null, ['class'=>'form-control', 'id'=>'contact', 'data-rule-required'=>'true', 'data-msg-required'=> trans('admin::messages.required-enter', ['name' => trans('admin::controller/user.contact')]), 'minlength' => '10', 'maxlength' => '20']) !!}
    </div>
    <div class="form-group">
