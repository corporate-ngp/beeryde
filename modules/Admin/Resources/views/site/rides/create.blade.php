<div class="portlet box blue add-form-main">
    <div class="portlet-title togglelable">
        <div class="caption">
            <i class="fa fa-plus"></i>Add New Ride 
        </div>
        <div class="tools">
    ...
    <div class="portlet-body form display-hide">
        {!! Form::open(['route' => ['admin.rides.store'], 'method' => 'post', 'class' => 'form-horizontal city-form',  'id' => 'create-city', 'msg' => 'Ride added successfully.']) !!}
