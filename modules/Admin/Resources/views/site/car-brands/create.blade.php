<div class="portlet box blue add-form-main">
    <div class="portlet-title togglelable">
        <div class="caption">
            <i class="fa fa-plus"></i>Add New Car Brand 
        </div>
        <div class="tools">
    ...
    <div class="portlet-body form display-hide">
        {!! Form::open(['route' => ['admin.car-brands.store'], 'method' => 'post', 'class' => 'form-horizontal country-form',  'id' => 'create-country', 'msg' => 'Car Brand added successfully.']) !!}
