<div class="portlet box blue add-form-main">
    <div class="portlet-title togglelable">
        <div class="caption">
            <i class="fa fa-plus"></i>Add New Car Model
        </div>
        <div class="tools">
    ...
    <div class="portlet-body form display-hide">
        {!! Form::open(['route' => ['admin.car-models.store'], 'id' => 'create-state-form', 'method' => 'post', 'class' => 'form-horizontal state-form',  'msg' => 'Car Model added successfully.']) !!}
