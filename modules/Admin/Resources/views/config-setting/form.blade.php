    ...
    <div class="row">
        <div class="col-md-5">
            <div class="form-group">
                ...
                <div class="col-md-8">
                    {!! Form::select('config_category_id', [''=>'select'] + $categoryList, null,['class'=>'select2me form-control', 'id' => 'config_category_id', 'data-rule-required'=>'true', 'data-msg-required'=> trans('admin::messages.required-select', ['name' => trans('admin::controller/config-category.config-cat') ]) ]) !!}
