<div class="portlet box yellow-gold edit-form-main">
    <div class="portlet-title togglelable">
        <div class="caption">
            <i class="fa fa-pencil"></i>{!! trans('admin::messages.edit-name', ['name' => trans('admin::controller/faq.faq') ]) !!}
        </div>
        <div class="tools">
    ...
    <div class="portlet-body form">
        {!! Form::model($faq, ['route' => ['admin.faqs.update', $faq->id], 'method' => 'put', 'class' => 'form-horizontal panel faq-form','id'=>'edit-faq', 'msg' => trans('admin::messages.updated', ['name' => trans('admin::controller/faq.faq') ]) ]) !!}
