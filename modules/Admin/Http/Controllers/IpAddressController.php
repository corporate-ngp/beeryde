...
class IpAddressController extends Controller
{
    ...
    public function getData(Request $request)
    {
        ...
        return Datatables::of($ipAddresses)
                ->addColumn('ids', function ($ipAddress) {
                    return '<input type="checkbox" name="ids[]" value="' . $ipAddress->id . '">';
                })
    ...
    public function destroy(LoginFailLogDeleteRequest $request)
    {
        ...
        if ($result) {
            $response = ['status' => 'success', 'message' => trans('admin::messages.deleted', ['name' => 'Login Log Details'])];
        } else {
            $response = ['status' => 'fail', 'message' => trans('admin::messages.not-deleted', ['name' => 'Login Log Details'])];
        }
