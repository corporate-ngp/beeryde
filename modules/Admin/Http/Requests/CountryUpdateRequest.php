...
class CountryUpdateRequest extends Request
{
    ...
    public function rules()
    {
        $this->sanitize();
        return [
            'name' => 'required|alphaSpaces|max:200|unique:countries,name,' . $this->countries->id,
            'iso_code_2' => 'required|alpha|max:2|unique:countries,iso_code_2,' . $this->countries->id,
            'iso_code_3' => 'required|alpha|max:3|unique:countries,iso_code_3,' . $this->countries->id,
