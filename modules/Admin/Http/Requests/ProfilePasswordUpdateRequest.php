...
class ProfilePasswordUpdateRequest extends Request
{
    ...
    public function rules()
    {
        ...
        return [
            'current_password' => 'required|min:8|max:100|current_password:user,current_password,' . $cur_pwd,
    ...
    {
        return [
            'current_password.required' => trans('admin::messages.required-enter', ['name' => trans('admin::controller/user.password')]),
            'current_password.min' => trans('admin::messages.error-minlength-number', ['name' => trans('admin::controller/user.password'), 'number' => '8']),
            'current_password.max' => trans('admin::messages.error-maxlength-number', ['name' => trans('admin::controller/user.password'), 'number' => '100']),
