siteObjJs.admin.ipIpaddressJs = function () {
...
// Initialize all the page-specific event listeners here.
    ...
    var initializeListener = function () {
        ...
        $('body').on('click', '.delete', function (e) {
            ...
            function handleGroupAction(grid) {
                ...
                var actionUrl = 'ipaddress/' + loginFailId;
                jQuery.ajax({
                    url: actionUrl,
                    cache: false,
                    data: {
    ...
    var fetchDataForEdit = function () {
        $('.portlet-body').on('click', '.edit-form-link', function () {
            ...
            var actionUrl = 'ipaddress/' + category_id + '/edit';
            $.ajax({
                url: actionUrl,
                cache: false,
                dataType: "json",
                ...
                success: function (data)
                {
                    ...
                    siteObjJs.validation.formValidateInit('#edit-config-category', handleAjaxRequest);
                    $("#edit_form").find('#ip_address').ipAddress();
                },
    ...
    var handleAjaxRequest = function () {
        ...
        var ipaddress = formElement.find('#ip_address').val();
        if (ipaddress == '' || (ipaddress == '___.___.___.___' || ipaddress == '0.0.0.0')) {
            ipaddress = '';
        }
        formElement.find('#ip_address').ipAddress();
        if (!ipaddress.isIpv4()) { // or myip.isIpv6() 
        ...
        $.ajax(
                {
                    ...
                    success: function (data)
                    {
                        ...
                        $('.btn-collapse-form-edit').click();
                        $('.btn-collapse-form').click();
                    },
                    error: function (jqXhr, json, errorThrown)
                    {
                        var errors = jqXhr.responseJSON;
        ...
        grid.init({
            ...
            dataTable: {
                ...
                "columns": [
                    ...
                    {data: 'logindetails', name: 'logindetails'},
    ...
    return {
        ...
        init: function () {
            ...
            siteObjJs.validation.formValidateInit('#ipaddress-form', handleAjaxRequest);
        }
