            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            {!! Form::select('type_id', [''=>'Please Select'] +$userTypes, null, ['id' => 'select-role','class'=>'select2me form-control' , 'data-rule-required'=>'true', 'data-msg-required'=>trans('admin::messages.required-enter', ['name' => trans('admin::controller/usertypelinks.type_id-required')]) ]) !!}                            
