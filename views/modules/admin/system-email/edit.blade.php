                ...
                <div class="col-md-10">
                    <div class="radio-list">
                        <label class="radio-inline">
                            <div class="radio">
                                @if($systemEmail->status==1) <span class="checked">
                                    @else <span> @endif
                        ...
                        <label class="radio-inline">
                            <div class="radio">
                                @if($systemEmail->status==0)<span class="checked">
                                    @else <span> @endif
                                        {!! Form::radio('status', '0') !!}
                                    </span>
                            </div>
                    ...
                    <span class="help-block">{!! trans('admin::controller/system-email.status-help') !!}</span>
                </div>
            </div>
