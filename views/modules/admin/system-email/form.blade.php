<div class="form-body">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-md-9">
                    ...
                    <span class="help-block">Specify from email address. Eg. Beeryde &lt;contact@beeryde.com&gt; or just contact@beeryde.com</span>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-md-9">
                    {!! Form::select('email_type', [''=>'Select'] + $emailTo, null,['class'=>'select2me form-control', 'id' => 'email_type', 'data-rule-required'=>'true', 'data-msg-required'=>'Please select Category.']) !!}
    ...
    <div class="row form-group">
        ...
        <div class="col-md-10">
            {!! Form::textarea('text1', null, ['class'=>'form-control']) !!}
        </div>
    </div> 
    <div class="row form-group">
        <label class="control-label col-md-2">Email Signature</label>
        <div class="col-md-10">
            {!! Form::textarea('text2', null, ['class'=>'form-control']) !!}
        </div>
    </div>
</div>