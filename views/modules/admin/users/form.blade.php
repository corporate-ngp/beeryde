            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <div class="input-group">
                        ...
                        @if($from == 'create')
                        {!! Form::text('username', null, ['id' => 'user_name', 'class' => 'form-control', 'data-rule-required' => 'true', 'data-msg-required' => trans('admin::messages.required-enter', ['name' => trans('admin::controller/user.username')]), 'maxlength' => '60', 'minlength' => '8']) !!}
                        <span class="input-group-btn">
                            <a href="javascript:;" class="btn blue" id="username1_checker">
                                <i class="fa fa-check"></i> {!! trans('admin::messages.check') !!}</a>
                        </span>
                        @else 
                        {!! Form::text('username', null, ['disabled' => 'disabled', 'id' => 'user_name', 'class' => 'form-control', 'data-rule-required' => 'true', 'data-msg-required' => trans('admin::messages.required-enter', ['name' => trans('admin::controller/user.username')]), 'maxlength' => '60', 'minlength' => '8']) !!}
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-md-8">
                    {!! Form::text('email', null, ['id' => 'mask_number1', 'class' => 'form-control', 'data-rule-required' => 'true', 'data-msg-required' => trans('admin::messages.required-enter', ['name' => trans('admin::controller/user.email')]), 'data-rule-email' => 'true','data-msg-email' => trans('admin::messages.valid-enter', ['name' => trans('admin::controller/user.email')]), 'maxlength' => '100']) !!}
                </div>
            </div>
        </div>
        <div class="col-md-6">
