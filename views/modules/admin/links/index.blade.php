...
<div class="portlet box blue add-form-main">
    <div class="portlet-title togglelable">
        <div class="caption">
            <i class="fa fa-gift"></i>{!! trans('admin::controller/links.add_new_link') !!}
        </div>
        <div class="tools">
...
<div class="portlet light col-lg-12">
    ...
    <div class="portlet-title">
        <div class="pull-right">
            <p>Search: <input id="data-search" type="search" class="form-control input-inline" placeholder="" /></p>
            <p>{!! Form::select('search_link_category', [''=>'Search By Category'] + $categoryNames, '',['class'=>'form-control width-auto', 'id' => 'search_link_category', 'column-index' => '2']) !!}</p>
        </div>
    </div>
    @if(session()->has('ok'))
