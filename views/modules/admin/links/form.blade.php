<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-md-8">
                {!! Form::select('link_category_id',[''=>'Please Select'] +$categoryNames, null,['class'=>'select2me form-control', 'id' => 'link_category_id', 'data-rule-required'=>'true', 'data-msg-required'=>trans('admin::messages.required-enter', ['name' => trans('admin::controller/links.category')])]) !!}            
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-md-9">
                {!! Form::text('link_url', null, ['class'=>'form-control','id'=>'link_url', 'maxlength'=>50 ,'data-rule-required'=>'true', 'data-msg-required'=>trans('admin::messages.required-enter', ['name' => trans('admin::controller/links.link_url')]), 'data-rule-maxlength'=>'50', 'data-msg-maxlength'=>trans('admin::messages.error-maxlength', ['name'=>trans('admin::controller/linkcategory.header_text')])]) !!}
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-md-8">
                {!! Form::text('link_name',null, ['class'=>'form-control','id'=>'link_name', 'maxlength'=>100 ,'data-rule-required'=>'true', 'data-msg-required'=>trans('admin::messages.required-enter', ['name' => trans('admin::controller/links.link_name')]), 'data-rule-maxlength'=>'100', 'data-msg-maxlength'=>trans('admin::messages.error-maxlength', ['name'=>trans('admin::controller/linkcategory.link_name')])]) !!}
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-md-9">
                {!! Form::text('link_icon', null, ['class'=>'form-control','id'=>'link_icon', 'maxlength'=>50 ,'data-rule-required'=>'true', 'data-msg-required'=>trans('admin::messages.required-enter', ['name' => trans('admin::controller/links.link_icon')]), 'data-rule-maxlength'=>'50', 'data-msg-maxlength'=>trans('admin::messages.error-maxlength', ['name'=>trans('admin::controller/linkcategory.link_icon')])]) !!}
                {{--*/ $linkIcon = ($action=='update')?$links->link_icon:''; /*--}}
                <p><a href="javascript:;" id="showLinkIconsPopup">Select Icon</a>&nbsp;&nbsp;<span class="link-icon"><i class="{{$linkIcon}}"></i></span></p>
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-md-9">
                {!! Form::textArea('page_text', null, ['class'=>'form-control','id'=>'page_text']) !!}
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-md-8">
                {!! Form::select('links_assign[]',$userTypes, $selectedUserTypes,['multiple'=>'multiple','class'=>'select2me form-control', 'id' => 'links_assign', 'data-rule-required'=>'true', 'data-msg-required'=>trans('admin::messages.required-enter', ['name' => trans('admin::controller/links.links_assign')])]) !!}                            
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-md-9">
                {!! Form::select('pagination', $paginationArray, null,['class'=>'select2me form-control', 'id' => 'pagination', 'data-rule-required'=>'true', 'data-msg-required'=>trans('admin::messages.required-enter', ['name' => trans('admin::controller/links.pagination')])]) !!}
